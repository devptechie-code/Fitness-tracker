...
const THEMES = {
  ...
  adult: { icon:"💼", tokens:{"--bg":"#F1F5F9","--bg2":"#E2E8F0","--surface":"#ffffff","--primary":"#334155","--secondary":"#64748B","--accent":"#D97706","--text":"#0F172A","--text-soft":"#475569","--font-display":"'IBM Plex Sans',sans-serif","--font-body":"'IBM Plex Sans',sans-serif","--fs-base":"15px", "--hero-bg": "url('fitness_hero.jpg')", "--hero-overlay": "rgba(0,0,0,0.6)", "--hero-text": "#ffffff"} },
  ...
  pregnancy: { icon:"🤰", tokens:{"--bg":"#FDF2F8","--bg2":"#F0FDF4","--surface":"#ffffff","--primary":"#DB2777","--secondary":"#4F46E5","--accent":"#D97706","--text":"#4C1D95","--text-soft":"#7C3AED","--font-display":"'Fraunces',serif","--font-body":"'Inter',sans-serif","--fs-base":"16px", "--hero-bg": "url('maternal_hero.jpg')", "--hero-overlay": "rgba(0,0,0,0.5)", "--hero-text": "#ffffff"} },
  family: { icon:"🏠", tokens:{"--bg":"#F8FAFC","--bg2":"#EEF2FF","--surface":"#ffffff","--primary":"#4338CA","--secondary":"#059669","--accent":"#EAB308","--text":"#0F172A","--text-soft":"#475569","--font-display":"'IBM Plex Sans',sans-serif","--font-body":"'Inter',sans-serif","--fs-base":"15px", "--hero-bg": "url('fitness_hero.jpg')", "--hero-overlay": "rgba(0,0,0,0.7)", "--hero-text": "#ffffff"} }
};
